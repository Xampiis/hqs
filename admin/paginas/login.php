            ...
            <div class="p-5">
              ...
              <form class="user" name="login" method="post" data-parsley-validate>
                <div class="form-group">
                  ...
                  id="login" placeholder="Digite o seu login" required data-parsley-required-message="Preencha o Login!">
                </div>
                <div class="form-group">
                  <input type="password" name="senha" class="form-control form-control-user" 
                  id="senha" placeholder="Digite a sua senha" required data-parsley-required-message="Preencha a Senha!">
                </div>
                <div class="form-group">
